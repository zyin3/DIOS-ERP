...
urlpatterns = patterns('eclaim.expense.views',
    ...
    url(r'^category/create/$', 'create_expense_category'),
    ...
    # expense/xxx/delete_expense_item/yyy
    url(r'^(?P<expense_slug>[-\w]+)/delete_expense_item/(?P<itemId>[-\w]+)/$', 'delete_expense_item'),


    # expense/xxx/edit_expense_item/yyy
    url(r'^(?P<expense_slug>[-\w]+)/edit_expense_item/(?P<itemId>[-\w]+)/$', 'edit_expense_item'),
